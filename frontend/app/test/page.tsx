...
const BillManagement = () => {
  ...
  useEffect(() => {
    ...
    const fetchBills = async () => {
      try {
        const cusome_token =
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzI2MzAxMzE2LCJpYXQiOjE3MjU2OTY1MTYsImp0aSI6IjRmZmYwMjY5NDg2YTRkNGRiNTMzNTg1YWM3ZGNlOGU1IiwidXNlcl9pZCI6MTB9.nbQ95V5iTFgS_kY_ohwbmA6Xvr4iVnzbOTNJd94B0ac";
        const response = await fetch("http://127.0.0.1:8000/api/main/bills/", {
          method: "GET",
          //   headers: {
  ...
  return <div className="min-h-screen bg-black text-white flex flex-col"></div>;
};
